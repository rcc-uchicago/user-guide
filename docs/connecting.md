...
|  <div style="width:150px">Connection Method | Description | Compute | Data Transfer | Data Sharing |  
| ------------------------------------------- | ----------- | ------- | ------------- | ------------ | 
...
|SAMBA (SMB)| Can be used to access data | No | Yes (two-way) | No |
|Globus| Can be used to access and share data and scheduled data transfers | No | Yes (two-way) | External and RCC collaborators |
|HTTP (web)| Can be used to share data for public access (legacy service) | No | Yes (one-way) | Public |ß